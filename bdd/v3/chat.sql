...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  mer. 13 mai 2020 à 22:14
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `pp` varchar(150) NOT NULL DEFAULT 'src/img/defaut.png',
  PRIMARY KEY (`id`)
...
INSERT INTO `user` (`id`, `login`, `name`, `surname`, `mail`, `password`, `rank`, `pp`) VALUES
(3, 'nana', 'sarah', 'chaouati', 'nana@laplateforme.io', '$2y$05$ClIqmzm2PM7kBuCbkEEb7.087yW9tAuJgxLvAAFJpSafRc7AbjSV6', 'membre', 'src/img/defaut.jpg');
COMMIT;
